...
python evaluate.py --config config.yaml --pred_path results/rCM_predictions.csv --custom_surv data/group34_rCM_samples.csv --output_metrics results/evaluation_metrics_ensmbled_rCM.json
...
python evaluate.py --config config.yaml --pred_path results/sjmb03_predictions.csv --custom_surv data/surv_sj_high.csv --output_metrics results/evaluation_metrics_ensmbled_sjmb03.json